...
class Model_CNN_GaitPart:
    def __init__(self,
        ...
        self.encoder = GaitPart(**model_cfg).float()
    ...
    def fit(self):
        ...
        for seq, view, seq_type, label, batch_frame in train_loader:
            ...
            tfa_feature, feature = self.encoder(*seq, batch_frame)
    ...
    def transform(self, flag, batch_size=1):
        ...
        for i, x in enumerate(data_loader):
            ...
            _, feature = self.encoder(*seq, batch_frame)
